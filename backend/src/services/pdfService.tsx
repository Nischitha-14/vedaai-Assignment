  ...
  <Document title={`${paper.subject} Question Paper`}>
    <Page size="A4" style={styles.page} wrap>
      ...
      <View style={styles.studentBox}>
        <Text>Name: ____________________   Roll No: ____________________   Section: ____________________</Text>
      </View>
...
export const generateQuestionPaperPdf = async ({
  ...
  assignmentTitle: string;
  paper: QuestionPaper;
}) => renderToBuffer(<QuestionPaperPdfDocument assignmentTitle={assignmentTitle} paper={paper} />);
